...
public:
  ...
  /**
   * Determine if the binary search tree is proper.
   * 
   * \return True if the tree is proper, false otherwise.
   */
  // TODO: this is a stub! Write this method and the required
  // private helper method.
  bool isProper() { return false; }
